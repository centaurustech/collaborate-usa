...
$ignore = array_flip(array('pageindex', 'search_it', 'category', 'action_title', 'action_key', 'cost_dir', 'points', 'limits_per_day', 'is_active')); //for reset type func
...
<div>
	...
	switch($orderby)
    {
        ...
        case '5': $orderby = 'limits_per_day'; break;
        case '6': $orderby = 'is_active'; break;
	}
	...
	switch($orderby)
    {
        ...
        case 'limits_per_day': $orderby = '5'; break;
        case 'is_active': $orderby = '6'; break;
	}
	?>
    ...
    <tr>
        ...
        <th valign="top" width="24%" nowrap><a href="<?php echo rebuildurl(array("orderby" => 1, "orderdi" => $orderby == 1 && $orderdi == "ASC" ? "DESC" : "ASC")); ?>">
            Action
        ...
        <th valign="top" width="16%" nowrap><a href="<?php echo rebuildurl(array("orderby" => 3, "orderdi" => $orderby == 3 && $orderdi == "ASC" ? "DESC" : "ASC")); ?>">
            Key
        ...
        <th valign="top" width="11%" nowrap><a href="<?php echo rebuildurl(array("orderby" => 5, "orderdi" => $orderby == 5 && $orderdi == "ASC" ? "DESC" : "ASC")); ?>">
            Limits Per Day
        ...
        <th valign="top" width="10%" nowrap><a href="<?php echo rebuildurl(array("orderby" => 6, "orderdi" => $orderby == 6 && $orderdi == "ASC" ? "DESC" : "ASC")); ?>">
            Is Active
    ...
    <tr>
        ...
        <input type="text" id="points" name="points" value="<?php echo $sr_points; ?>" style="width:40px;" maxlength="3" onblur="filter_x(this);" /></th>
...
<br />
<div style="float:left; font-style:italic;">This Section is used to set <b>Patronage Points</b> allocation configurations.</div>
