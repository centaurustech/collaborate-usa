...
class Mod_Create_River extends Mod_Voice {
    ...
    private function _upload_eco_system_image(){
        ...
        if($user_folder["status"] == true){
            ...
            $user_voice_folder = $this->Mod_File_System->create_folder($path, 'ecosystem');
            ...
            // folder not created
                ...
                // write log
                $this->log("ecosystem folder not be created in $user_id folder; function _upload_eco_system_image; file mod_create_voice", "error");
                
                // set message
                $this->_set_message(self::ERROR, "River not created kindly contact the support. with this error code " . USER_ECOSYSTEM_FOLDER_NOT_CREATED);
            ...
            // write log
            $this->log("$user_id folder not be created in $path folder; function _upload_eco_system_image; file mod_create_river", "error");
            
            // set message
            $this->_set_message(self::ERROR, "River not created kinly contact support. with this error code " . USER_FOLDER_NOT_CREATED);
