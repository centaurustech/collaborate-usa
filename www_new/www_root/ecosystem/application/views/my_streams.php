...
<div class="leftcont brdrnone"> 
    <span class="mainbanner">
        <img src="<?php echo c_get_assets_url(); ?>images/my_streams.jpg" alt="My Voice" />
    </span>
    <div class="withbor" style="border: none;">

        <!-- my streams data -->
        <div id="my_stream_data">
        </div>
...
<script type="text/javascript">
    ...
    var st = 0;
    function loadMyStreams(_s){
        var url = "<?php echo base_url() . $config['my_streams_url']; ?>/my_streams_ajax";
        var data = {s: _s};
