...
function upload_btn($fld_name, $field_class='', $field_style='', $btn_class='', $package_style='', $btn_style='', $file_field_style='', $btn_value='browse', $file_type='')
{
    ...
    <div>
        <div style=\"float:left; padding-right:5px; width:81.5%;\">
    ...
    <div style='text-align:left;'>
    	...
    	style=\"cursor:default; position:absolute; z-index:2; width:255px; height:30px;
        margin-top:-41px; {$style_2} {$file_field_style}
