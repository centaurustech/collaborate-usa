...
function notification_email($user_info, $notification, $created_on)
{
    global $consts;
    $site_url = $consts['SITE_URL'];
    ...
    $prf_pic = "{$site_url}user_files/prof/{$user_info['user_id']}/{$user_info['profile_pic']}";
    }

    $body_in = "";
    $body_in.= "Dear <b>{$user_info['user_ident']}</b>,<br /><br />";
    ...
    $body_in.= "<div style='color:#2CA1F4; padding-top:2px;'>
    <div style=\"display:inline-block; width:60px; height:52px; vertical-align:top;\"><img src=\"{$prf_pic}\" style='width:50px; height:50px; border-radius:5px;' /></div>
    <div style=\"display:inline-block;\">
        <div style=\"color:#666; font-style:italic; font-size:11px;\">{$created_on}</div>
    ...
    $body_in.= "In order to review the details, please <a href='{$site_url}signin' target='_blank' style='color:#2CA1F4; text-decoration:none;'>Signin</a> to your account.<br /><br />";
    $body_in.= "Note: If you wish not to receive this notification in future, you may change the <b>Notification Settings</b> after you login.<br />";
