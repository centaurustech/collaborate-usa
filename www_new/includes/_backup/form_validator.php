...
class Validator
{
     ...
     */
    public function __construct($data, $fields = array(), $lang = null, $langDir = '/')
    {
        ...
        //$langFile = rtrim($langDir, '/') . '/form_validator_lang_' . $lang . '.php'; //works only with
        $langFile = $langDir.'form_validator_lang_'.$lang.'.php';

        //var_dump($langFile, is_file($langFile)); die();
